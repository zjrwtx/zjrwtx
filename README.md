...
I use to the core contributor of [CAMEL](https://github.com/camel-ai/camel) agent framework、[OWL](https://github.com/camel-ai/owl) agent framework、[Loong](https://github.com/camel-ai/loong) data generation project. And i also join the [Eigent]（https://github.com/eigent-ai/eigent） agent product before.
